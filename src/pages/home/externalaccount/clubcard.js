...
<div class="col-xl-3 col-lg-3 col-md-3">
    <div class="card">
        <div class="card-body text-center ribbon">
            <img src={CLUB_LOGO_URL.concat(data?.logo_url)} className="rounded-circle img-thumbnail" alt={CLUB_LOGO_URL.concat(data.logo_url)} style={{width : '150px', height : '150px'}} />
