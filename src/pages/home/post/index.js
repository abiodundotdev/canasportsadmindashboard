        ...
        return (
            ...
            <div>{eachpost.post_title}</div>
                <div className="d-flex justify-content-between">
                    <Link href={"/home/post/editpost?postid="+eachpost.id}><a>Edit  </a></Link> <a className="text-primary" onClick={()=> deletepost(eachpost.id, eachpost.post_title) } style={{cursor : "pointer"}}>Trash</a>
                </div>
            </td>
            <td className="">
