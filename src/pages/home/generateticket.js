...
export default function GenerateTicket(props){
    ...
    return(
        ...
        <div className="section-body mt-3">
            <h6 className="text-center text-warning">Matches Listed below are unplayed Matches</h6>
        ...
        <div className="card">
               ...
               </div>
              {
               ...
               <table className="table table-hover">
                    <thead>
                        <tr>
                        <th scope="col" ><small>Match ID</small></th>
                        <th scope="col" rowSpan="1" title="Points"><small>Team A</small></th>
                        <th scope="col" rowSpan="1" title="Goal Difference"><small>Team B</small></th>
