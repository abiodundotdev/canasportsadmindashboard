...
export default function SportHome(){
    ...
    return (
        <DashLayout title="Notifier">
        <div className="section-body mt-3">
      
        <div className="card p-4">
           <Link href="/home/sendnew"><a className="btn btn-sm btn-primary">Send New Mail/Mesage</a></Link>
...
<thead>
    ...
    <th scope="col"><small>Content</small></th>
    <th scope="col"><small>Category</small></th>
    <th scope="col"><small>Sent At </small></th>
